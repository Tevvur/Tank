...
pygame.display.set_caption("AZATSHNIR")

bulletSound=pygame.mixer.Sound('vistrel.wav')
explosionSound=pygame.mixer.Sound('vzriv.wav')
...
def give_coordinates(tank):
    ...
    p=Pulya(x,y,(0,0,0),tank.direction)
    pulya.append(p)
#==================================================
def collision():
    for p in pulya: 
...
def score():
    ...
    res = font.render(str(score1), True, (0, 0, 0))
    res1 = font.render(str(score2), True, (0, 0, 0))
    screen.blit(res, (30,30))
    screen.blit(res1, (750,30))

mainloop = True
tank1 = Tank(350,350,3,(255, 0, 0))
tank2 = Tank(100,100,3,(0, 255, 0),pygame.K_d,pygame.K_a,pygame.K_w,pygame.K_s,pygame.K_SPACE)
